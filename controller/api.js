...
exports.show = (function(req, res) {
    ...
    //DogTag.findOne({name: Wally}, function(error, dogtag) {
...
exports.near = function(req, res) {
    DogTag.find({coord : { $near : [req.params.lon, req.params.lat], $maxDistance : req.params.dist/68.91}}, function (error, dogtag) {        
        res.setHeader('Content-Type', 'text/javascript;charset=UTF-8');
        res.send(req.query["callback"] +'({"records":' + JSON.stringify(dogtag) + '});');
    })
}
